...
public class RepeatedCharOccuranceInString {

	public static void main(String[] args) {

		Scanner scan = new Scanner(System.in);
		System.out.println("Enter String to find the repeated occurrence of char:");
		...
		for (int i = 0; i < str.length(); i++) 
		   ...
		   if (flag > 1)  
		      System.out.println("Repeated occurrence of char " + str.charAt(i)
